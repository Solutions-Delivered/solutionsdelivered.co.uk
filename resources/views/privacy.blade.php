    ...
    <div class="max-w-4xl mx-auto prose prose-lg">
        ...
        <div class="bg-gray-50 rounded-lg p-6">
            ...
            <p class="text-gray-700">
                Email: <a href="mailto:privacy@solutionsdelivered.co.uk" class="text-[#198fd9] hover:text-[#D65FCB]">privacy@solutionsdelivered.co.uk</a>
            </p>
            <p class="text-gray-700 mt-2">
                Alternatively, use our <a href="{{ route('get-started') }}" class="text-[#198fd9] hover:text-[#D65FCB]">contact form</a>.
            </p>
        </div>
        ...
        <div class="bg-gray-50 rounded-lg p-6">
            ...
            <p class="text-gray-700">Website: <a href="https://ico.org.uk" target="_blank" rel="noopener noreferrer" class="text-[#198fd9] hover:text-[#D65FCB]">ico.org.uk</a></p>
