...
@section('meta_description', 'You have made too many requests. Please wait a moment and try again.')

@section('content')
<!-- 429 Header -->
<section class="relative overflow-hidden bg-gradient-to-br from-purple-600 via-purple-500 to-purple-700 text-white py-20 px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative">
                ...
                <ul class="text-left space-y-3 max-w-md mx-auto">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-700">Wait a few moments before trying again</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-[#198fd9] mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="text-gray-700">Avoid rapidly clicking buttons or refreshing the page</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-[#198fd9] mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="text-gray-700">This limit helps us maintain a great experience for everyone</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl p-10 text-center border border-gray-200">
            ...
            <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                If you're experiencing persistent issues, please contact us and we'll be happy to help.
            </p>
