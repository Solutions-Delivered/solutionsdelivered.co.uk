...
@section('content')
<!-- 403 Header -->
<section class="relative overflow-hidden bg-gradient-to-br from-orange-600 via-orange-500 to-orange-700 text-white py-20 px-4 sm:px-6 lg:px-8">
...
<section class="py-20 px-4 sm:px-6 lg:px-8 bg-white" aria-labelledby="error-heading">
    <div class="max-w-3xl mx-auto text-center">
        ...
        <div class="relative bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-lg border border-gray-100 p-10">
            ...
            <div class="relative">
                <h3 class="text-2xl font-bold text-gray-900 mb-4">Why am I seeing this?</h3>
                <ul class="text-left space-y-3 max-w-md mx-auto">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-700">You may not have the required permissions</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-[#198fd9] mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="text-gray-700">The page may require authentication</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-[#198fd9] mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="text-gray-700">This resource may be restricted</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl p-10 text-center border border-gray-200">
            ...
            <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                If you believe you should have access to this page, please contact us and we'll be happy to help.
            </p>
