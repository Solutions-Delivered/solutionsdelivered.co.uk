...
@section('meta_description', 'Your page has expired. Please refresh and try again.')

@section('content')
<!-- 419 Header -->
<section class="relative overflow-hidden bg-gradient-to-br from-yellow-600 via-yellow-500 to-yellow-700 text-white py-20 px-4 sm:px-6 lg:px-8">
...
<section class="py-20 px-4 sm:px-6 lg:px-8 bg-white" aria-labelledby="error-heading">
    <div class="max-w-3xl mx-auto text-center">
        ...
        <p class="text-xl text-gray-600 mb-12 leading-relaxed">
            For your security, this page has expired. Please refresh the page and try again.
        </p>
        ...
        <div class="relative bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-lg border border-gray-100 p-10">
            ...
            <div class="relative">
                <h3 class="text-2xl font-bold text-gray-900 mb-4">Why did this happen?</h3>
                <ul class="text-left space-y-3 max-w-md mx-auto">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-700">Your security token expired (this is normal after some time)</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-[#198fd9] mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="text-gray-700">The page was open for too long before submitting</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 text-[#198fd9] mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="text-gray-700">Simply refresh the page to get a new token and try again</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl p-10 text-center border border-gray-200">
            ...
            <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                If refreshing doesn't help, please get in touch and we'll resolve the issue.
            </p>
