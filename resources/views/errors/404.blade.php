    ...
    <div class="max-w-3xl mx-auto text-center">
        ...
        <div class="bg-gray-50 rounded-lg p-8 mb-8">
            ...
            <nav aria-label="Error page navigation">
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('home') }}" class="text-[#198fd9] hover:text-[#D65FCB] font-medium transition-colors duration-200 underline">
                            Return to Home Page
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('solutions') }}" class="text-[#198fd9] hover:text-[#D65FCB] font-medium transition-colors duration-200 underline">
                            View Our Solutions
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('about') }}" class="text-[#198fd9] hover:text-[#D65FCB] font-medium transition-colors duration-200 underline">
                            Learn About Us
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('get-started') }}" class="text-[#198fd9] hover:text-[#D65FCB] font-medium transition-colors duration-200 underline">
                            Get in Touch
                        </a>
                    </li>
                </ul>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('home') }}" class="inline-block bg-[#198fd9] text-white hover:bg-[#D65FCB] px-8 py-3 rounded-md text-lg font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#198fd9]">
                Go to Home Page
            </a>
...
<section class="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
    <div class="max-w-3xl mx-auto text-center">
        ...
        <a href="{{ route('get-started') }}" class="inline-block bg-[#198fd9] text-white hover:bg-[#D65FCB] px-6 py-2 rounded-md font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#198fd9]">
            Contact Us
        </a>
    </div>
</section>
