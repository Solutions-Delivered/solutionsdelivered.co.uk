...
<!-- Why Join Us Section -->
<section class="py-8 sm:py-12 md:py-14 lg:py-16 px-4 sm:px-6 lg:px-8 bg-white" aria-labelledby="why-join-heading">
    <div class="max-w-7xl mx-auto">
        <h2 id="why-join-heading" class="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
            Why Join Solutions Delivered?
        </h2>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl p-6 sm:p-7 md:p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-200">
...
<section class="py-8 sm:py-12 md:py-14 lg:py-16 px-4 sm:px-6 lg:px-8 bg-gray-50" aria-labelledby="looking-for-heading">
    <div class="max-w-4xl mx-auto">
        <h2 id="looking-for-heading" class="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
            What We Look For
        </h2>
...
<section class="py-10 sm:py-14 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-white" aria-labelledby="opportunities-heading">
    <div class="max-w-4xl mx-auto text-center">
        ...
        <h2 id="opportunities-heading" class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Current Opportunities
        </h2>
        <p class="text-base sm:text-lg md:text-xl text-gray-600 mb-12 leading-relaxed max-w-2xl mx-auto">
