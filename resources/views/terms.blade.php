...
<section class="py-16 px-4 sm:px-6 lg:px-8 bg-white">
    <div class="max-w-4xl mx-auto prose prose-lg">
        ...
        <p class="text-gray-700 mb-4">
            We process personal data in accordance with UK GDPR and our <a href="{{ route('privacy') }}" class="text-[#198bd9] hover:text-[#65bd7d]">Privacy Policy</a>. For client engagements, data processing terms will be specified in separate Data Processing Agreements as required.
        </p>
        ...
        <div class="bg-gray-50 rounded-lg p-6">
            ...
            <p class="text-gray-700">
                Email: <a href="mailto:info@solutionsdelivered.co.uk" class="text-[#198bd9] hover:text-[#65bd7d]">info@solutionsdelivered.co.uk</a>
            </p>
            <p class="text-gray-700 mt-2">
                Or use our <a href="{{ route('get-started') }}" class="text-[#198bd9] hover:text-[#65bd7d]">contact form</a>.
            </p>
        </div>
    </div>
</section>
